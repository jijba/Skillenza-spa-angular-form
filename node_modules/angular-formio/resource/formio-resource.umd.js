(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('native-promise-only'), require('formiojs'), require('formiojs/utils'), require('@angular/router'), require('lodash'), require('@angular/common'), require('rxjs'), require('@angular/forms'), require('formiojs/components/Components'), require('ngx-bootstrap/pagination')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'native-promise-only', 'formiojs', 'formiojs/utils', '@angular/router', 'lodash', '@angular/common', 'rxjs', '@angular/forms', 'formiojs/components/Components', 'ngx-bootstrap/pagination'], factory) :
	(factory((global['formio-resource'] = {}),global.core,global.Promise$1,global.formiojs,global.FormioUtils,global.router,global.lodash,global.common,global.rxjs,global.forms,global.Components,global.pagination));
}(this, (function (exports,core,Promise$1,formiojs,FormioUtils,router,lodash,common,rxjs,forms,Components,pagination) { 'use strict';

Promise$1 = Promise$1 && Promise$1.hasOwnProperty('default') ? Promise$1['default'] : Promise$1;
FormioUtils = FormioUtils && FormioUtils.hasOwnProperty('default') ? FormioUtils['default'] : FormioUtils;
Components = Components && Components.hasOwnProperty('default') ? Components['default'] : Components;
...
var FormioResourceService = /** @class */ (function () {
    function FormioResourceService(appConfig, config, loader, resourcesService) {
        ...
        this.onParents = new core.EventEmitter();
        this.onIndexSelect = new core.EventEmitter();
    ...
    function () {
            ...
            if (_this.resources.hasOwnProperty(parent)) {
                parentsLoaded.push(_this.resources[parent].resourceLoaded.then(function (resource) {
                    ...
                    _this.formLoaded.then(function (form) {
                        var /** @type {?} */ component = FormioUtils.getComponent(form.components, parent);
                        if (component) {
        ...
        Promise$1.all(parentsLoaded).then(function (parents) {
    ...
    function (resource) {
        var _this = this;
        var /** @type {?} */ formio = resource._id ? this.formio : this.formFormio;
        return formio
...
var FormioResourceEditComponent = /** @class */ (function () {
    ...
    function (submission) {
        var _this = this;
        var /** @type {?} */ edit = this.service.resource;
    ...
    function () {
        ...
        if (this.service &&
            ...
            this.service.onParents.subscribe(function (parents) {
                lodash.each(parents, function (parent) {
                    if (parent) {
...
var FormioComponent = /** @class */ (function () {
    ...
    function (form) {
        ...
        // Create the form.
        return formiojs.Formio.createForm(lodash.get(this.formioElement, 'nativeElement', null), this.form, {
    ...
    function (submission) {
        ...
        var /** @type {?} */ beforeSubmit = lodash.get(this.options, 'hooks.beforeSubmit');
        if (beforeSubmit) {
...
var FormBuilderComponent = /** @class */ (function () {
    ...
    function () {
        var _this = this;
        formiojs.Formio.builder(this.builderElement.nativeElement, this.form, this.options).then(function (instance) {
...
var FormioGridComponent = /** @class */ (function () {
    ...
    function (query) {
        ...
        this.formio
            ...
            _this.rows = [];
            lodash.each(submissions, function (submission) {
    ...
    function (column) {
        ...
        lodash.each(this.columns, function (col) {
     ...
     */
    function (row, col) {
        var /** @type {?} */ cellValue = lodash.get(row, col.key);
