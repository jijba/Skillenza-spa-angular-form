...
var FormBuilderComponent = /** @class */ (function () {
    ...
    function () {
        var _this = this;
        Formio.builder(this.builderElement.nativeElement, this.form, this.options).then(function (instance) {
...
function FormBuilderComponent_tsickle_Closure_declarations() {
